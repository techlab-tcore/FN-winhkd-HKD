...
<nav class="page-header d-block text-decoration-none p-3 fs-5 d-flex justify-content-between align-items-center mb-3">
    ...
    <label class="mx-auto ms-5 ps-3"><?=$secTitle;?></label>
...
<div class="input-group mb-3">
    <span class="input-group-text rounded-0"><i class='bx bxs-flag-alt'></i></span>
    <select class="form-control form-control-lg form-select rounded-0" name="regionCode" required>
...
<div class="input-group mb-3">
    ...
    <input type="text" class="form-control form-control-lg rounded-0" pattern="^[0-9]{8,12}$" name="mobile" placeholder="<?=lang('Input.mobileno');?> .eg.0123456789" required>
...
<div class="input-group mb-3">
    <span class="input-group-text rounded-0"><i class="bx bxs-mobile-vibration"></i></span>
    <input type="text" class="form-control form-control-lg rounded-0" name="veritac" placeholder="<?=lang('Validation.sendsmstac');?>" required>
    <button type="button" class="btn btn-tac" id="timer" onclick="requestSmsTac2('smsRegisForm');"><?=lang('Nav.gettac');?></button>
</div>
<button type="submit" class="btn btn-login text-uppercase"><?=lang('Nav.createacc');?></button>

<article class="mt-4">
<p><?=lang('Validation.regis4');?></p>
