...
<section class="card bg-secondary my-3 shadow">
    <div class="card-body">
        <?=form_open('deposit/bank-info/'.$bank, ['class'=>'form-validation bankTransferForm','novalidate'=>'novalidate'],['currency'=>$currency]);?>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-8 payment-method">
                ...
                <span class="d-inline-block position-relative bank-transfer"><?=lang('Input.banktransfer');?></span>
                <?php endif; ?>
            </div>
        </div>
        <div class="mb-3">
