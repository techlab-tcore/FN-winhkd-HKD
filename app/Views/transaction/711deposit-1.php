...
<section class="card bg-dark my-3 shadow">
    <div class="card-body">
        <?=form_open('deposit/711-qr-final', ['class'=>'form-validation qr711Form','novalidate'=>'novalidate'],['bank'=>$bank,'accNo'=>$accNo,'cardNo'=>$cardNo,'currency'=>$currency,'qrimg'=>$qrUrl]);?>
        <div class="row mb-3">
        ...
        <article class="mt-4">
            <p><?=lang('Validation.pgatewaysentence3',[100,3000]);?></p>
            <p><?=lang('Validation.pgatewaysentence4');?></p>
        </article>
    </div>
</section>
